...
usersRoutes.patch('/:user_id/admin', (req, res) => turnUserAdminController.handle(req, res))
usersRoutes.get('/:user_id', (req, res) => showUserProfileController.handle(req, res))
